    ...
    <div className="py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-8 items-center">
          ...
          <div className="flex justify-center">
             <p className="text-3xl font-bold text-slate-400">r/travel</p>
          </div>
          <div className="flex justify-center">
             <p className="text-3xl font-bold text-slate-400">r/finance</p>
          </div>
          <div className="flex justify-center">
             <p className="text-3xl font-bold text-slate-400">r/mind</p>
          </div>
        </div>
      </div>
    </div>
